...
print("\nValores negativos en Year:", (df["Year"] < 1900).sum())  # Un año antes de 1900 no es válido
...
df[['Year', 'kmDriven', 'Transmission', 'AskPrice']] = df[['Year', 'kmDriven', 'Transmission', 'AskPrice']].fillna(df.median())
...
df.to_csv("used_car_dataset_cleaned.csv", index=False)

print("\nDataset limpio guardado como 'used_car_dataset_cleaned.csv'")
